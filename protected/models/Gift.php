...
class Gift extends CActiveRecord
{
	...
	/**
	* Retorna presentes que ainda não foram escolhidos.
	* @return lista de presentes
	*/
	public function getFree()
	{
		return array_merge(
			array(array('id'=>0,'description'=>'Outro')),
			Yii::app()->db
				->createCommand('SELECT * FROM gift WHERE id NOT IN (SELECT gift_id FROM giver)')
				->queryAll());
	}
}